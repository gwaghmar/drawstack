...
const TEST_1_DOC: CanvasDocument = {
  ...
  shapes: [
    ...
    },
    {
      ...
      chartType: "donut",
      donutData: [
        { label: "Enterprise", value: "$7.2M", percent: 58, color: "#4A85F6" },
        { label: "Pro Team", value: "$3.8M", percent: 31, color: "#8B5CF6" },
    ...
    },
    {
      ...
      groupedData: [
        { category: "Q1", series: [{ name: "Actual", value: 2.4, color: "#4A85F6", formatted: "$2.4M" }, { name: "Budget", value: 2.2, color: "#A1A1AA", formatted: "$2.2M" }] },
        { category: "Q2", series: [{ name: "Actual", value: 2.9, color: "#4A85F6", formatted: "$2.9M" }, { name: "Budget", value: 2.7, color: "#A1A1AA", formatted: "$2.7M" }] },
        { category: "Q3", series: [{ name: "Actual", value: 3.4, color: "#4A85F6", formatted: "$3.4M" }, { name: "Budget", value: 3.1, color: "#A1A1AA", formatted: "$3.1M" }] },
        { category: "Q4E", series: [{ name: "Estimated", value: 3.8, color: "#f59e0b", formatted: "$3.8M", isEstimate: true }, { name: "Budget", value: 3.5, color: "#A1A1AA", formatted: "$3.5M" }] },
      ],
      x: 620,
      y: 280,
      width: 620,
