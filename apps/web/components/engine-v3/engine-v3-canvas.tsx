  ...
  return (
    <main className="flex min-h-[680px] flex-col overflow-hidden bg-[#F7F8F4] text-[#15171A]">
      ...
      <div className="flex min-h-0 flex-1">
        {!canvasFocus ? <aside className="flex max-h-[calc(100vh-7rem)] w-[68px] shrink-0 flex-col items-center gap-1 overflow-y-auto border-r border-[#D7DBD2] bg-white px-2 py-3" aria-label="Create tools">
