      ...
      <div className="flex min-h-0 flex-1">
        ...
        <section ref={canvasViewportRef} className="relative min-w-0 flex-1 overflow-auto bg-[#E9EBE6] p-4 sm:p-8" aria-label="Editable canvas">
          ...
          {(selectedGroupBounds || (selectedBounds && selectedNode && selectedNode.id !== activePage.root.id)) ? (() => {
            ...
            return <div role="toolbar" aria-label="Quick object actions" className="absolute z-50 flex items-center gap-1 rounded-lg border border-[#C8CEC4] bg-white/95 p-1 shadow-lg backdrop-blur" style={{ left: Math.max(4, Math.min(bounds.left, activePage.width - 220)), top: Math.max(4, bounds.top - 44) }} onPointerDown={stop}>
